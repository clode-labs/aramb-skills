...
- npx mcporter call aramb_mcp.toolkits_connect_toolkit toolkit="github"   # when check_connection.connected=false; share returned redirect_url
- npx mcporter call aramb_mcp.toolkits_get_github_credential               # then export GH_TOKEN and use native git/gh CLI
